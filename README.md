...
- [claude-brain](https://github.com/toroleapinc/claude-brain) - Sync your Claude Code brain (memory, skills, agents, rules, settings) across machines via Git. Auto-syncs on session start/end with intelligent semantic merging, conflict resolution, and API key stripping.
