...
- [claude-kit](https://github.com/luiseiman/claude-kit) - Configuration factory for Claude Code with 13 composable technology stacks, audit scoring (0-10), and a practices pipeline. Bootstraps, syncs, and audits .claude/ project configuration.
