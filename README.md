...
- [Better Harness](https://github.com/QoderAI/better-harness) - A Claude Code plugin for diagnosing and continuously improving the Agent Work Loop using repository and session evidence.
