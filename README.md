...
- [Agent QA](https://github.com/vostride/agent-qa) - Source-available self-improving QA agent for natural-language web and mobile tests. Connect it to Claude Code with `agent-qa mcp`, or use its portable skills for test authoring, result triage, and evidence-backed debug-and-fix workflows.
