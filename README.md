...
- [Reporecall](https://github.com/proofofwork-agency/reporecall) - Local codebase memory for Claude Code. Pre-indexes your repo with Tree-sitter AST parsing (22 languages), builds call graphs, and injects relevant context via hooks in ~5ms. Also works as an MCP server. npm: `@proofofwork-agency/reporecall`.
