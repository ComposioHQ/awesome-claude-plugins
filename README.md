...
- [ejentum-mcp](https://github.com/ejentum/ejentum-mcp) - MCP server with four tools (`harness_reasoning`, `harness_code`, `harness_anti_deception`, `harness_memory`) and matching SKILL.md files. Ships an Anthropic plugin manifest in `.claude-plugin/`.
