...
- [x-twitter-scraper](https://github.com/Xquik-dev/x-twitter-scraper) - X API and Twitter scraper skill for AI coding agents. Search tweets, look up users, export followers, monitor accounts, run giveaway draws, and call the Xquik REST API, MCP server, and webhooks.
