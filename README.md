...
- [dna-claude-analysis](https://github.com/shmlkv/dna-claude-analysis) - Personal genome analysis toolkit. Analyzes raw DNA data across 17 categories (health risks, ancestry, pharmacogenomics, nutrition, and more) and generates a terminal-style HTML dashboard.
