...
- [dsh-deepread](./dsh-deepread) - Deep-reading assistant: five modes (quick, deep, knowledge-map, Feynman, full book) to extract core claims, argument structure, and key evidence from books and articles; exports Markdown, FreeMind/XMind mindmaps, and HTML reports.
