...
- [Wopee MCP](https://www.npmjs.com/package/wopee-mcp) - MCP server for autonomous testing — dispatch test runs, AI agent tests, and analysis crawls for web apps from Claude.
