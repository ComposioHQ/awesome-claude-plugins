...
- [architect-builder](./architect-builder) - Three-phase AI development workflow that separates planning, implementation, and review into auditable handoff files for Claude Code and Codex.
