...
- [BrotherSBE](https://github.com/khalilmaaouni/BrotherSBE) - Designs backend and data systems in order (purpose, process, architecture, data, expression, verification) and holds the result to gates that actually run, numbers, migrations, approvals, tests, reporting absent evidence as NO-DATA rather than a pass. Free, MIT licensed.
