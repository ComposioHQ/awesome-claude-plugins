...
- [templateclaw](https://github.com/jeromwolf/templateclaw) - Developer template hub with 32 production-ready templates across 6 categories (Landing Pages, Dashboards, UI Components, Dev Methodology, Project Setup, Refactoring). 7 slash commands for instant project scaffolding. Compatible with Claude Code, Codex, Gemini CLI, and Cursor.
