...
- [HOTL](https://github.com/yimwoo/hotl-plugin) - Human-on-the-Loop workflow plugin that adds design, planning, review, and verification guardrails so AI-generated changes do not land without evidence. Works with Claude Code, Codex, and Cline.
