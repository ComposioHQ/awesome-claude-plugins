...
- [screenshot-janitor](./screenshot-janitor) - Finds screenshots that pile up during each Claude Code session and, before you leave, asks to move them to the Trash. macOS + Linux, per-session scoping, safe recoverable deletion, zero dependencies.
