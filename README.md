...
- [cove](./cove) - Chain-of-Verification (CoVe) validation that fact-checks claims, plans, and code changes. Generates independent verification questions and checks each by actually reading files and running commands, returning VERIFIED / REFUTED / PARTIAL.
